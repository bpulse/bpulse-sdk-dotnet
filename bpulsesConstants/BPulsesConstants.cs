...
namespace bpulse_sdk_csharp.bpulsesConstants
{
    ...
    public class BPulsesConstants
    {
        ...
        public const string BPULSE_PROPERTY_MAX_NUMBER_PULSES_TO_PROCESS_TIMER =
            "bpulse.client.maxNumberPulsesReadFromTimer";

        public const string BPULSE_PROPERTY_MAX_PULSESDB_SIZE_BYTES = "bpulse.client.pulsesRepositoryDBMaxSizeBytes";

        public const string BPULSE_PROPERTY_MEM_PULSES_REPOSITORY_MAX_NUM_PULSES =
            "bpulse.client.pulsesRepositoryMemMaxNumberPulses";
